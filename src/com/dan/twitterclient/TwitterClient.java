...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "HOYUoBRgsieSOiPk67SbQ";       // Change this
    public static final String REST_CONSUMER_SECRET = "4luQ0R24eEErdTzEoAQU0l6D8fTR5TRBCGaK5P6Vs"; // Change this
    ...
    public void getHomeTimeline(String maxId,AsyncHttpResponseHandler handler){
    	String query = "statuses/home_timeline.json";
    	if(maxId != null){
    		query += "?max_id="+maxId;
    	}
    ...
    public void getMentions(String maxId,AsyncHttpResponseHandler handler){
    	String query = "statuses/mentions_timeline.json";
    	if(maxId != null){
    		query += "?max_id="+maxId;
    	}
    	String url = getApiUrl(query);
    ...
    public void getUserTimeline(String sn,String maxId,AsyncHttpResponseHandler handler){
    	String query = "statuses/user_timeline.json";
    	if(sn != null){
